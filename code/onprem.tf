...
resource "azurerm_role_assignment" "afs_storage_account_rbac" {
  scope                = "/subscriptions/${local.config["ARM_SUBSCRIPTION_ID"]}/resourceGroups/${var.rg_onprem}/providers/Microsoft.Storage/storageAccounts/${var.storage_account_name}"
